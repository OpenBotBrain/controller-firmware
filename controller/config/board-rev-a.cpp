...
static constexpr GPIOInitConfig s_gpio_init_rev_a[] =
{
    ...
    { INPUT1_PIN5_IO,                CONFIG_TYPE_I1_OUTPUT, GPIOB, GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    ...
    { INPUT1_PIN5_IO,                CONFIG_TYPE_I1_I2C,    GPIOB, GPIO_PIN_10, GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF7_USART3,  GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    { INPUT1_PIN6_IO,                CONFIG_TYPE_I1_INPUT,  GPIOB, GPIO_PIN_10, GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    { INPUT1_PIN6_IO,                CONFIG_TYPE_I1_OUTPUT, GPIOB, GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    ...
    { INPUT1_PIN6_IO,                CONFIG_TYPE_I1_I2C,    GPIOB, GPIO_PIN_11, GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF7_USART3,  GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    ...
    { INPUT2_PIN5_IO,                CONGIG_TYPE_I2_SERIAL, GPIOC, GPIO_PIN_10, GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF8_UART4,   GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    { INPUT2_PIN6_IO,                CONGIG_TYPE_I2_SERIAL, GPIOC, GPIO_PIN_11, GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF8_UART4,   GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    ...
    { INPUT3_PIN5_IO,                CONGIG_TYPE_I3_SERIAL, GPIOD, GPIO_PIN_5,  GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF7_USART2,  GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
    { INPUT3_PIN6_IO,                CONGIG_TYPE_I3_SERIAL, GPIOD, GPIO_PIN_6,  GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF7_USART2,  GPIO_SPEED_FREQ_HIGH,      DONT_CARE },
