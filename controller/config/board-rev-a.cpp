...
static constexpr GPIOInitConfig s_gpio_init_rev_a[TOTAL_GPIO] =
{
    ...
    { MOTORAB_FAULT_N_IO,            CONFIG_TYPE_DEFAULT, GPIOD, GPIO_PIN_9,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE },
    ...
    { MOTORCD_FAULT_N_IO,            CONFIG_TYPE_DEFAULT, GPIOE, GPIO_PIN_7,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE },
