...
static constexpr GPIOInitConfig s_gpio_init_rev_a[] =
{
    ...
    { INPUT1_PIN6_IO,                CONFIG_TYPE_I1_INPUT,  GPIOB, GPIO_PIN_11, GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE },
    { INPUT1_PIN6_IO,                CONFIG_TYPE_I1_OUTPUT, GPIOB, GPIO_PIN_11, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_LOW   },
    ...
    { MOTORD_PIN6_ENCODER_IO,        CONFIG_TYPE_DEFAULT,   GPIOB, GPIO_PIN_14, GPIO_MODE_IT_RISING, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_MEDIUM,    DONT_CARE },
    { MOTORD_PIN5_ENCODER_IO,        CONFIG_TYPE_DEFAULT,   GPIOB, GPIO_PIN_15, GPIO_MODE_IT_RISING, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_MEDIUM,    DONT_CARE },
    ...
    { INPUT2_PIN5_IO,                CONFIG_TYPE_I2_OUTPUT, GPIOC, GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_LOW   }, // IO is shared with INPUT2_PIN5_SCL_IO
    ...
    { INPUT2_PIN6_IO,                CONFIG_TYPE_I2_OUTPUT, GPIOC, GPIO_PIN_11, GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_LOW   }, // IO is shared with INPUT2_PIN6_SDA_IO
    ...
    { INPUT3_PIN5_IO,                CONFIG_TYPE_I3_INPUT,  GPIOD, GPIO_PIN_5,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE }, // IO is shared with INPUT3_PIN5_SCL_IO
    { INPUT3_PIN5_IO,                CONFIG_TYPE_I3_OUTPUT, GPIOD, GPIO_PIN_5,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_LOW   }, // IO is shared with INPUT3_PIN5_SCL_IO
    ...
    { INPUT3_PIN5_IO,                CONFIG_TYPE_I3_I2C,    GPIOD, GPIO_PIN_5,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE }, // IO is shared with INPUT3_PIN5_SCL_IO
    { INPUT3_PIN6_IO,                CONFIG_TYPE_I3_INPUT,  GPIOD, GPIO_PIN_6,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE }, // IO is shared with INPUT3_PIN6_SDA_IO
    { INPUT3_PIN6_IO,                CONFIG_TYPE_I3_OUTPUT, GPIOD, GPIO_PIN_6,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_LOW   }, // IO is shared with INPUT3_PIN6_SDA_IO
    ...
    { INPUT3_PIN6_IO,                CONFIG_TYPE_I3_I2C,    GPIOD, GPIO_PIN_6,  GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       DONT_CARE }, // IO is shared with INPUT3_PIN6_SDA_IO
    ...
    { POWER_SUPPLY_IO,               CONFIG_TYPE_DEFAULT,   GPIOE, GPIO_PIN_8,  GPIO_MODE_OUTPUT_OD, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_LOW,       SET_HIGH   },
    ...
    { ADDRESS_LED_RGB_IO,            CONFIG_TYPE_DEFAULT,   GPIOF, GPIO_PIN_8,  GPIO_MODE_AF_PP,     GPIO_NOPULL,  GPIO_AF2_TIM5,    GPIO_SPEED_FREQ_LOW,       DONT_CARE },
    ...
    { SYS_IMU_CS_IO,                 CONFIG_TYPE_DEFAULT,   GPIOG, GPIO_PIN_5,  GPIO_MODE_OUTPUT_PP, GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_HIGH,      SET_HIGH  },
    ...
    { INPUT2_PIN5_SCL_IO,            CONFIG_TYPE_I2_INPUT,  GPIOG, GPIO_PIN_14, GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_MEDIUM,    DONT_CARE }, // It is shared with INPUT2_PIN5_IO
    { INPUT2_PIN5_SCL_IO,            CONFIG_TYPE_I2_OUTPUT, GPIOG, GPIO_PIN_14, GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_MEDIUM,    DONT_CARE }, // It is shared with INPUT2_PIN5_IO
    { INPUT2_PIN5_SCL_IO,            CONGIG_TYPE_I2_SERIAL, GPIOG, GPIO_PIN_14, GPIO_MODE_INPUT,     GPIO_NOPULL,  0,                GPIO_SPEED_FREQ_MEDIUM,    DONT_CARE }, // It is shared with INPUT2_PIN5_IO
...
{
    { UART_TYPE_DEBUG_SERIAL, LPUART1, 921600, DMA2_Channel6, DMA_REQUEST_4, DMA2_Channel6_IRQn, DMA2_Channel7, DMA_REQUEST_4, DMA2_Channel7_IRQn, PRI_HARD_LPUART1,   LPUART1_IRQn },
    { UART_TYPE_PORT_INPUT_1, USART3,  115200, DMA1_Channel2, DMA_REQUEST_2, DMA1_Channel2_IRQn, DMA1_Channel3, DMA_REQUEST_2, DMA1_Channel3_IRQn, PRI_HARD_PORT_UART, USART3_IRQn  },
...
{
    { I2C_TYPE_PORT_INPUT_1, I2C4, 0x10909CEC, I2C1_EV_IRQn, I2C1_ER_IRQn, PRI_HARD_PORT_I2C },
    { I2C_TYPE_PORT_INPUT_2, I2C1, 0x10909CEC, I2C2_EV_IRQn, I2C2_ER_IRQn, PRI_HARD_PORT_I2C },
    { I2C_TYPE_PORT_INPUT_3, I2C2, 0x10909CEC, I2C3_EV_IRQn, I2C3_ER_IRQn, PRI_HARD_PORT_I2C },
    { I2C_TYPE_SYSTEM,       I2C3, 0x10909CEC, I2C4_EV_IRQn, I2C4_ER_IRQn, PRI_HARD_SYS_I2C  },
};
