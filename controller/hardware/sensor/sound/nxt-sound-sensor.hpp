...
*/
enum class NXT_Sound_Sensor_Mode
{
    UNDEFINED = 0,
    DB,
    DBA
...
class NXTSoundSensor : public LegoSensor
{
    public:

        NXTSoundSensor(InputPort* port);

        NXTSoundSensor(InputPort* port, NXT_Sound_Sensor_Mode sensor_mode);
    ...
    private:
        ...
        NXT_Sound_Sensor_Mode m_sensor_mode;
};
