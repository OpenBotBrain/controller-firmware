...
bool LSM6DS::accelerometer_init()
{
    ...
    switch (ctrlx & 0x0C)
    {
        case LSM6DSL_ACC_FULLSCALE_2G:
            m_val_to_nm2 = max_reading * 2.0f;
            break;

        case LSM6DSL_ACC_FULLSCALE_4G:
            m_val_to_nm2 = max_reading * 4.0f;
            break;

        case LSM6DSL_ACC_FULLSCALE_8G:
            m_val_to_nm2 = max_reading * 8.0f;
            break;

        case LSM6DSL_ACC_FULLSCALE_16G:
            m_val_to_nm2 = max_reading * 16.0f;
            break;
        default: break;
    }
...
bool LSM6DS::read_accelerometer()
{
    ...
    for (int i = 0; i < TOTAL_AXIS; i++)
    {
        m_acceleration[i] =(float)(pnRawData[i] * m_val_to_nm2);
    }
